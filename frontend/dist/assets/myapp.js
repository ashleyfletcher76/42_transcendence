  ...
  let PongGameComponent = _exports.default = (_class = class PongGameComponent extends _component2.default {
    ...
    stopKeyPolling() {
      if (this.pollingInterval) {
        ...
        this.pollingInterval = null; // Clear the reference
      }
    }
    ...
    writable: true,
    initializer: null
  }), _descriptor11 = _applyDecoratedDescriptor(_class.prototype, "user", [_service.inject], {
    configurable: true,
    enumerable: true,
    writable: true,
    initializer: null
  }), _descriptor12 = _applyDecoratedDescriptor(_class.prototype, "router", [_service.inject], {
    configurable: true,
    enumerable: true,
    writable: true,
    initializer: null
...
;define("myapp/services/tournament", ["exports", "@ember/service", "@glimmer/tracking", "@ember/object"], function (_exports, _service, _tracking, _object) {
  ...
  let TournamentService = _exports.default = (_class = class TournamentService extends _service.default {
    constructor(...args) {
      ...
      _initializerDefineProperty(this, "gameData", _descriptor5, this);
    ...
    async updateCurrentPlayers(parsedMessage) {
      if (!this.currentPlayers || this.currentPlayers.length === 0) {
        // If `currentPlayers` is empty, fetch data for all players in `this.parsedMessage.players`
        console.log(parsedMessage);
        this.currentPlayers = await Promise.all(parsedMessage.players.map(player => this.fetchUserData(player)));
        console.log("test1");
      } else {
        // Otherwise, fetch data for a single player and add to `currentPlayers`
    ...
    async fetchUserData(nickname) {
      console.log("fetch USer: ", nickname);
      try {
        const response = await fetch('/users/users/profile-info/', {
          method: 'POST',
          headers: {
    ...
    writable: true,
    initializer: null
  }), _descriptor5 = _applyDecoratedDescriptor(_class.prototype, "gameData", [_service.inject], {
    configurable: true,
    enumerable: true,
    writable: true,
    initializer: null
    ...
    writable: true,
    initializer: null
  }), _descriptor7 = _applyDecoratedDescriptor(_class.prototype, "currentLobby", [_tracking.tracked], {
    configurable: true,
    enumerable: true,
    writable: true,
    initializer: function () {
  ...
  }), _descriptor8 = _applyDecoratedDescriptor(_class.prototype, "currentPlayers", [_tracking.tracked], {
    configurable: true,
    enumerable: true,
    writable: true,
    initializer: function () {
